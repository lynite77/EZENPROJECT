...
<body>
 		 <table bgcolor="#232325">
          	<tr>
         		<td onClick="location.href='<%=tPath%>/member/login.jsp'" style="cursor:pointer;"><img src="images/account.png" border="0" width="300px" height="300px"></td>
         	...
         	<tr>
         		...
         		<td onClick="location.href='<%=tPath%>/datalog/download_csv.jsp'" style="cursor:pointer;"><img src="images/downdata.png" border="0" width="300px" height="300px"></td>
         	</tr>
  		 </table>
</body>
</html>